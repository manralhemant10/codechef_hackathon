...
const Search = (props)=>{
   ...
   const getUserTags=async()=>{
        ...
        const res = await axios.get("https://codechefmrtenhunter.000webhostapp.com/users/tags",
    ...
    const  getTags=async()=>{
       const res = await axios.get("https://codechefmrtenhunter.000webhostapp.com/tags")
